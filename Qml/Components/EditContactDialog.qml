...
Dialog {
    ...
    signal contactUpdated(int index, string firstName, string lastName, string email,
    ...
    function loadContact(index, data) {
        contactIndex = index
        firstNameField.customText = data.firstName || ""
        lastNameField.customText = data.lastName || ""
        emailField.customText = data.email || ""
        phoneField.customText = data.phone || ""
        companyField.customText = data.company || ""
        jobTitleField.customText = data.jobTitle || ""
        addressField.customText = data.address || ""
        notesField.customText = data.notes || ""
                    ...
                    Repeater {
                        ...
                        delegate: Button {
                            ...
                            onClicked: {
                                ...
                                set.has(modelData) ? set.delete(modelData) : set.add(modelData)
                                root.selectedTags = Array.from(set)
                            }
                        }
